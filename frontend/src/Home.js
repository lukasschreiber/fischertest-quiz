...
export default function Home() {
    ...
    const handleCreateQuiz = () => {
        ...
        if (body.title) {
            fetch("https://fqb.lukasschreiber.com/user/" + authed + "/quiz", { method: "POST", headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(body) })
                .then(body => body.json())
                .then(json => {
                    fetch("https://fqb.lukasschreiber.com/user/" + authed + "/quiz").then(body => body.json()).then(json => {
